...
# Basic dependencies
sudo apt install -y linux-kernel-amd64 linux-headers-amd64 extrepo git htop curl wget nano python3-venv python3-pip fonts-mononoki fonts-noto-color-emoji flatpak kitty pkexec libnotify-bin pipx python-is-python3
